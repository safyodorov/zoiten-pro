...
**Revision (2026-07-03, адверсариальное ревью 5 линз + 2-голосная верификация):** точечные правки
B1–B4/M1–M6/m1–m8 внесены в планы. Изменённые задачи/тесты: 24-01-T1 (сид `finance.taxCalcStartQuarter`),
24-01-T2 (+п.6 карточка дашборда, m3), 24-02 (новая `computeQuarterAccrual` + сигнатура
`computeTaxLiability({accruedTotal, taxesPaidTotal})` + B3-кейс «факт+платёж внутри Q»), 24-03-T2
(forPay-хвост — стат-токен WB_API_TOKEN + пост-фильтр saleDt, B4/M1), 24-03-T3 (декод JWT scope, M6),
24-04 (stageAsOf undated m7), 24-05-T1/T3 (авансы point-in-time B1/B2, кредиты M3, налоги B3/M4,
CNY m4), 24-06-T2 (degraded m5, monday от snapshotDate M2), 24-07-T1/T2 (compare-дата M5, CNY-строка m4),
24-08-T1 (версионирование ручных статей m8). Команды верификации в Per-Task Map не изменились.
