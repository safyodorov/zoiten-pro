        ...
        <div className="max-h-[70vh] space-y-4 overflow-y-auto pr-1 text-sm">
          ...
          <div className="space-y-2">
            ...
            <Item term="Авансы поставщикам">
              Оплата закупок ДО отгрузки (этап «Производство» / «Инспекция» или без этапа).
              Суммы = оплачено поставщику; приводятся в рубли по курсу ЦБ на дату платежа
              (⚠ приближённо, если курса на дату ещё нет в базе).
            </Item>
            <Item term="Товар готовый к отгрузке">
              Оплаченные закупки на этапе «Готов к отгрузке» (SHIPMENT) — оплачен, готов,
              ещё не отгружен. Курс ЦБ на дату платежа.
            </Item>
            <Item term="Товар в пути">
              Оплаченные закупки на этапе «В пути» (TRANSIT) — товар в дороге, ещё не принят
              на склад. Курс ЦБ на дату платежа.
            </Item>
          ...
          <div className="space-y-2">
            ...
            <Item term="Кредиты и займы">
              Две строки: «Остаток тела» (тело кредита − погашенная часть на дату) и «Начисленные
              проценты» — проценты, набежавшие с даты последнего платежа до выбранной даты
              (пропорционально по графику: % ближайшего планового платежа × прошедшие дни ÷ дни
              периода). Кредит, не выданный на выбранную дату, не учитывается.
            </Item>
          ...
          <div className="space-y-1.5 border-t pt-3 text-xs text-muted-foreground">
            ...
            <ul className="list-disc space-y-1 pl-4">
              ...
              <li>
                Курсы валют — ЦБ РФ, дневной sync с 09.06.2026 + исторический бэкфилл с марта
                2026; для дат без курса (выходные ЦБ) берётся ближайший ранний курс (приближение).
              </li>
              <li>
