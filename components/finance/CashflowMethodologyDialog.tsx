        ...
        <div className="max-h-[70vh] space-y-4 overflow-y-auto pr-1 text-sm">
          ...
          <div className="rounded-md border border-amber-300 bg-amber-50 px-3 py-2 text-xs dark:bg-amber-950/30">
            ...
            <p className="mt-1 text-amber-700 dark:text-amber-500">
              ...
              упрощены (8% = 7% + 1% от выкупов квартала, одним платежом в конце квартала).
              В v2 — per-товар payout из юнит-экономики и разделение налоговых баз по юрлицам.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Item term="Налоги (расчётно)">
              8% (7% НДС + 1% налог) от плановых выкупов квартала — одним платежом в последний
              день квартала (для H2-2026: 30.09 и 31.12). Упрощённая модель v1.
            </Item>
            <Item term="Опекс">
          ...
          <div className="space-y-1.5 border-t pt-3 text-xs text-muted-foreground">
            ...
            <ul className="list-disc space-y-1 pl-4">
              ...
              <li>
                Налоги упрощены: 8% от выкупов квартала одним платежом в конце квартала. v2:
                разделение per-юрлицо, НДС отдельно.
              </li>
              <li>
                Выплаты WB за выкупы до начала горизонта не моделируются — притоки первых
                ~1–2 недель занижены, возможен ложный ранний «разрыв».
              </li>
              <li>
