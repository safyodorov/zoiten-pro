    ...
    <div className="mx-auto max-w-[1600px] space-y-6">
      ...
      <details className="rounded-lg border bg-muted/30 p-4 text-sm">
        ...
        <ul className="mt-3 list-disc space-y-1 pl-5 text-muted-foreground">
          ...
          <li><b>Ставка кредита 25% годовых</b>; кредит привлекается при дефиците ДС <b>траншами кратно 5 млн ₽</b> (минимум и шаг). <b>Минимальный срок 1 год</b> — в пределах годового горизонта досрочного гашения нет, свободные средства накапливаются в остатке ДС.</li>
