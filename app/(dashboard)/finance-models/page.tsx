    ...
    <div className="mx-auto max-w-[1600px] space-y-6">
      ...
      <details className="rounded-lg border bg-muted/30 p-4 text-sm">
        ...
        <ul className="mt-3 list-disc space-y-1 pl-5 text-muted-foreground">
          ...
          <li><b>Ставка кредита 25% годовых</b>; кредит привлекается при дефиците ДС <b>траншами кратно 5 млн ₽</b> (минимум и шаг). Срок — 1 год, гашение <b>дифференцированное и ежемесячное</b>: тело равными долями (по 1/12 в месяц), проценты — на остаток долга (убывающие).</li>
